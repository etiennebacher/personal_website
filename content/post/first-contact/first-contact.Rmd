...
summary: A blog post describing the first steps of data cleaning and analysis using R.
tags: ["R", "Stata"]
output:
  blogdown::html_page:
    toc: true
...
```{r include = FALSE}
base1 <- read_excel(here("public/Data/first-contact/Base_Excel.xlsx"), sheet = "Base1")
base2 <- read_excel(here("public/Data/first-contact/Base_Excel.xlsx"), sheet = "Base2")
base3 <- read_excel(here("public/Data/first-contact/Base_Excel.xlsx"), sheet = "Base3")
base4 <- read.table(here("public/Data/first-contact/Base_Text.txt"), header = TRUE)
```
